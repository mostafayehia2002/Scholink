              ...
              <nav class="navbar navbar-expand">
                          ...
                          <li class="nav-item dropdown dropdown-large">
                              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button"
                                  ...
                                  <p style="margin: 0; display: flex; align-items: center">
                                      <span style="font-size: 18px; font-weight: 400">{{ LaravelLocalization::getCurrentLocaleNative() }}</span>
                              ...
                              <div class="dropdown-menu dropdown-menu-end" style="width: 150px">
                                  <div class="row row-cols-1 g-3 p-3">
                                      ...
                                      @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                          <a class="dropdown-item" rel="alternate" hreflang="ar" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                              {{ $properties['native'] }}
                                          </a>
                                      @endforeach
                                  </div>
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                  ...
                                  <div class="header-message-list">
                                      ...
                                      <a class="dropdown-item" href="javascript:;">
                                          <div class="d-flex align-items-center">
                                              <div class="user-online">
                                                  <img src="{{asset('assets/images/avatars/avatar-8.pn')}}g" class="msg-avatar"
                                                      alt="user avatar" />
                                              </div>
                                              <div class="flex-grow-1">
                                                  <h6 class="msg-name">
                  ...
                  <div class="user-box dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                          ...
                          <li>
                              <a class="dropdown-item" onclick="document.getElementById('form-logout').submit()" href="javascript:;"><i

@extends('layouts.master', ['title' => 'New Admins'])
@section('content')
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{__('admins.new_admin')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{__('admins.new_admin')}}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action="{{ route('admin.admins.store') }}" method="POST">
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary px-5">{{__('admins.save')}}</button>
                        </div>
                    </form>
                </div>
            </div>

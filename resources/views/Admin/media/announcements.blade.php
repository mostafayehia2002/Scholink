                            ...
                            <div class="modal-body">
                                <form class="row g-3" method="POST"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" step="any" min="0" name="price" value="" required class="form-control">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputAddress2"
                                                ...
                                                <form class="row g-3" method="POST"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <select class="form-select mb-3" name="subcategory_id"
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option
                                                                    @selected($category->id==$ann->subcategory_id) value="{{$category->id}}">{{$category->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="inputAddress2"
                                                               class="form-label">Price</label>
                                                        <input type="number" step="any" min="0" name="price" value="{{$ann->price}}" required class="form-control">
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="inputAddress2"

                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="row g-3" method="POST" action="{{ route('admin.guidelines.store') }}">
                                        @csrf
                                        <div class="col-12">
                                            <label for="inputAddress2" class="form-label">Content</label>
                                            <textarea class="form-control" id="inputAddress2" name="content" required placeholder="Enter Message" rows="3"></textarea>
                                        </div>
                                                        ...
                                                        <form class="row g-3" method="POST"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="hidden" value="{{ $row->id }}"
                                                                    name="id">
                                                                <textarea class="form-control" id="inputAddress2" name="content" required placeholder="Enter Message"
